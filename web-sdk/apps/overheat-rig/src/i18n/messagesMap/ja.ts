...
const ja = {
	...
	replay_row_base_bet_social: '基本プレイ',
	replay_row_cost_mult: 'コスト倍率',
	replay_row_total_bet: '合計ベットコスト',
	replay_row_total_bet_social: '合計プレイコスト',
	replay_row_payout_mult: '配当倍率',
	replay_row_payout_mult_social: '勝利倍率',
